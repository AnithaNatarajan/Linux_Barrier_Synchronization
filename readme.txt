Assignment 3: To develop a barrier synchronization mechanism in Linux kernel
which can be invoked by user processes via system call interface.
...
1. Patch the diff to the kernel module using the below commands from linux directory and compile the new kernel:
	"patch <kernel_location < syscall.patch"  
